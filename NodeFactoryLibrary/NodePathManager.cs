...
namespace NodeFactoryLibrary
{
    ...
    public class NodePathManager
    {
        ...
        public NodePathManager(String EFConnectionString)
        {
            ...
            {
               new LabelNodeAccess(EFConnectionString),
                new InfoNodeAccess(EFConnectionString)
            };
        }
        ...
        public void DeleteOnlyItSelfAndItsChildren(string nodePath)
        {

        }
        /// <summary>
        ///按照路径删除数据本身以及它与其他对象之间的关联，而不删除与其关联的
        /// </summary>
      //  public void DeleteItSelfAndOnlyItsAssociationOfNodeAndItsChildren(string nodePath)
